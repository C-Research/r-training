...
Once that package has been installed, now you should be able to load it, and have access to `starwars` (we'll work with columns `name`, `height`, `mass`, `gender`, and `homeworld`):
