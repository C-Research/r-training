...
- [dplyr cheatsheet](https://github.com/C-Research/r-training/blob/main/cheatsheets/dplyr-cheatsheet.pdf)
...
```{r read, eval = FALSE}
# import data file
git <- "https://raw.githubusercontent.com/C-Research/"
hub <- "r-training/main/data/nba2018-players.csv"
...
- [command line cheatsheet](https://github.com/C-Research/r-training/blob/main/cheatsheets/command-line-cheatsheet.pdf)
